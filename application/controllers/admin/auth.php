...
class Auth extends CI_Controller {
    ...
    function index() {
        if (!$this->ion_auth->logged_in()) {
            ...
            $data ['users'] = $this->load->view('auth/index', $this->data, TRUE);
    ...
    //log the user in
    function login() {
        $this->data['title'] = "Thanh Tuan System Login";
        //validate form input
    ...
    function change_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($change) {
                ...
                $this->session->set_flashdata('message', $this->ion_auth->errors());
                redirect(base_url('panel/change_password'), 'refresh');
            }
        }
    }
    ...
    function forgot_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($forgotten) {
                ...
                $this->session->set_flashdata('message', $this->ion_auth->errors());
                redirect("panel/forgot_password", 'refresh');
            }
        }
    }
...
//echo '----------'.$activation;
        if ($activation) {
            ...
            $this->session->set_flashdata('message', $this->ion_auth->messages());
            redirect($this->panel_link."/auth", 'refresh');
        } else {
    ...
    function deactivate($id = NULL) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['users'] = $this->load->view('auth/deactivate_user', $this->data, TRUE);
            $this->load->view("panel/home", $data);
        } else {
...
//                if ($this->_valid_csrf_nonce() === FALSE || $id != $this->input->post('id')) {
            ...
            redirect(base_url() . "panel/auth", 'refresh');
        }
    }
    ...
    function create_user() {
        ...
        $this->form_validation->set_rules('user_name', 'Username', 'required|xss_clean|max_length[100]|alpha|is_unique[users.username]');
        $this->form_validation->set_rules('email', 'Email Address', 'required|valid_email|is_unique[users.email]');
        $this->form_validation->set_rules('phone1', 'Phone', 'required|xss_clean|min_length[10]|max_length[11]');
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data)) {
            ...
            $data['users'] = $this->load->view('auth/create_user', $this->data, TRUE);
            $this->load->view('panel/home', $data);
        }
    }
...
//        );
        ...
        $data['users'] = $this->load->view('auth/edit_user', $this->data, TRUE);
        $this->load->view('panel/home',$data);
    }
