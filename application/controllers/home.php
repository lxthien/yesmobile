...
class Home extends MY_Controller {
    ...
    public function index() {
        ...
        $data['productIntermediate'] = $this->_productIntermediate();
    ...
    public function you_should_watch() {
        $latest_downloads = $this->newsModel->you_should_watch();
        return $latest_downloads;
    }
    
    private function _productHight(){
        $newestProductLst = $this->product_model->productHight();
    ...
    private function _productIntermediate(){
        $newestProductLst = $this->product_model->productIntermediate();
