...
class MY_Model extends CI_Model {
	...
	function add($options = array())
	{
		...
		{                    
//                    show_error ('Some required field not filled, Please check your data');
                    return 'Some required field not filled, Please check your data';    
		}
		...
		$default = array(
			'date_add' => date($this->config->item('log_date_format')),
			'date_upd' => date($this->config->item('log_date_format'))
		);
