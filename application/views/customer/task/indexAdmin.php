            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                            <div class="icons"><i class="fa fa-table"></i></div>
                            <h5>MÁY XÁC LẤY LINH KIỆN</h5>
                            <ul class="nav nav-tabs pull-left">
                                <li class="active"><a href="#chvt41" data-toggle="tab" aria-expanded="true">VŨNG TÀU</a></li>
                                <li class=""><a href="#chls41" data-toggle="tab" aria-expanded="false">LONG SƠN</a> </li>
                            </ul>
                        </header>
                        <div id="collapse4" class="body tab-content">
                            <div class="tab-pane fade active in" id="chvt41">
                                <?php if(count($tasksXacVT) > 0) : ?>
                                <table id="dataTableTask41" class="table table-bordered table-condensed">
                                    <thead>
                                    <tr>
                                        <th></th>
                                        <th>Mã số</th>
                            ...
                            <div class="tab-pane fade in" id="chls41">
                                <?php if(count($tasksXacLS) > 0) : ?>
                                <table id="dataTableTask41_LS" class="table table-bordered table-condensed">
                                    <thead>
                                    <tr>
                                        <th></th>
                                        <th>Mã số</th>
                                        ...
                                        <?php foreach ($tasksCustomerReceivedVT as $row): ?>
                                            ...
                                            <tr style="<?php echo $cssBg.$cssBgVip; ?>">
                                                ...
                                                <?php } else { ?>
                                                    <td><span style="color:<?php echo isTaskNotifyCustomerEnd($row->id) ? '#ffffff' : 'red'; ?>;"><?php echo is_numeric($row->phonePrice) ? number_format($row->phonePrice) : ($row->phonePrice == '' ? "KT, báo giá" : $row->phonePrice); ?></span></td>
                                                <?php } ?>
                                                <td><?php echo formatTimeLineBreak($row->timeClosedTask, false, false); ?></td>
