                    ...
                    <div class="box">
                        <style type="text/css">
                            ...
                            section.table .row-table .col-table {
                                width: 40%; float: left; font-size: 12px; line-height: 20px;
                            }
                            section.table .row-table .col-table-2 {
                                width: 60%;
                            }
                        </style>
                        <div id="printTask">
                            <div class="cls2">
                                ...
                                <div class="wrapper">
                                    <div class="header">
                                        <div class="logo">
                                            <img src="https://yesmobile.com.vn/assets/images/logo-print.png">
                                            <p>Sửa Điện Thoại, Laptop, PC</p>
                                        </div>
                                        <div class="address">
                                            <p class="company"><strong>YES MOBILE | SỬA CHỮA ĐIỆN THOẠI, LAPTOP, PC </strong></p>
                                    ...
                                    <div class="cl"></div>
                                    <p class="title">PHIẾU BIÊN NHẬN SỬA CHỮA</p>
                                    <div class="cl"></div>
                                    <div class="pers">
                                        <div class="left">
                                        <section class="table table-bordered table-condensed table-hover table-striped">
                                              <div class="row-table">
                                                ...
                                                <div class="col-table col-table-2"><strong><?php echo getCustomerName($task->customer_id); ?></strong></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Số điện thoại</div>
                                                <div class="col-table col-table-2"><?php echo getCustomerPhone($task->customer_id); ?></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Thiết bị</div>
                                                <div class="col-table col-table-2"><strong><?php echo $task->phoneType; ?></strong></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Imei/Serial</div>
                                                <div class="col-table col-table-2"><?php echo $task->phoneImei; ?></div>
                                              </div>
                                              <div class="row-table">
                                               ...
                                               <div class="row-table">
                                                <div class="col-table">Lỗi thiết bị</div>
                                                <div class="col-table col-table-2"><strong><?php echo $task->phoneStatus; ?></strong></div>
                                              </div>
                                              <?php if ($task->features != '') { ?>
                                              <div class="row-table">
                                                <div class="col-table">Đặc điểm</div>
                                                <div class="col-table col-table-2"><strong><?php echo $task->features; ?></strong></div>
                                              </div>
                                              <?php } ?>
                                             <div class="row-table">
                                                <div class="col-table">Phụ kiện</div>
                                                <div class="col-table col-table-2"><?php echo $task->phoneSim; ?></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Lưu ý</div>
                                                <div class="col-table col-table-2"><?php echo $task->notePrivate; ?></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Chi phí sửa chữa</div>
                                                <div class="col-table col-table-2"><strong><?php echo is_numeric($task->phonePrice) ? number_format($task->phonePrice).' VND' : ($task->phonePrice == '' ? "Kiểm tra, báo giá trước khi sửa chữa" : $task->phonePrice); ?></strong></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Mã số dịch vụ</div>
                                                <div class="col-table col-table-2"><?php echo $task->code; ?></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Thời gian nhận máy</div>
                                                <div class="col-table col-table-2"><?php echo formatTime($task->created, true); ?></div>
                                              </div>
                                              <div class="row-table">
                                                <div class="col-table">Dự kiến sửa xong</div>
                                                <div class="col-table col-table-2"><strong><?php echo formatTime($task->warrantyPeriodEnd); ?></strong></div>
                                              </div>
                                        </section>
                                        </div>
                                        <div class="right">
                                            <p><b>Lưu ý:</b></p>
                                            <p>- Nếu bị mất phiếu, vui lòng gọi ngay: <strong>0847.727272</strong>.</p>
                                            <p>- Trường hợp máy treo logo, lên logo tắt, khi trả lại máy, có thể không trả lại được tình trạng ban đầu.</p>
                                            <p>- Biên nhận có giá trị nhận lại máy trong thời gian <strong>45 ngày.</strong></p>
                                            <p><b>Các trường hợp từ chối bảo hành:</b></p>
                                            <p>- Các chức năng Yes Mobile <b>không sửa chữa.</b></p>
                                            <p>- Tem bảo hành bị tẩy xóa, chỉnh sửa.</p>
                                            <p>- Trong thời gian bảo hành: Máy đã từng qua sửa chữa, bị ẩm nước, biến dạng, rớt, va đập...</p>
                                            <div class="footer">
