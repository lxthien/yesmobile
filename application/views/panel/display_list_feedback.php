...
<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>
    <tr>
        <td height='55' background='<?php echo RES_PATH; ?>images/panel/admin-blue_08.gif' valign='middle' style='padding-left:20px'>Customer Feedback Management</td>
...
<form action='<?php echo $page_link . '/delete'; ?>' method='post' name='form1' style='margin:0px'>
    <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
        <tr class="tr_title_bg">
            ...
            <td width ='40%' class="td_title_main" align="left">Content</td>
            <td width="25%" class="td_title_main" align="left">Customer</td>            
            <td width="20%" class="td_title_main" align="left">Designation</td>            
    ...
    <table width='100%' cellspacing='0' cellpadding='5' align='center' class='table_border_line'>
        ...
        foreach ($list_items as $row) {
            ...
            echo "<td width ='40%' align='left'><a href='" . $page_link . '/edit/' . $row->id . "'>" . $row->content . "</a></td>";
            echo "<td width = '25%' align='left'>" . $row->customer_name . "</td>";
            echo "<td width = '20%' align='left'>" . $row->designation . "</td>";
