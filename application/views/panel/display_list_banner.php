...
<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>
    <tr>
        <td height='55' background='<?php echo RES_PATH; ?>images/panel/admin-blue_08.gif' valign='middle' style='padding-left:20px'>Banner Management</td>
...
<form action='<?php echo $page_link.'/delete';?>' method='post' name='form1' style='margin:0px'>
    <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
        <tr class="tr_title_bg">
            ...
            <td width ='40%' class="td_title_main" align="left">Title</td>
            <td width="25%" class="td_title_main" align="left">Image</td>            
    ...
    <table width='100%' cellspacing='0' cellpadding='5' align='center' class='table_border_line'>
        ...
        foreach ($list_items as $row) {
            ...
            echo "<td width ='40%' align='left'><a href='". $page_link.'/edit/'.$row->id."'>". $row->title . "</a></td>";
            echo "<td width = '25%' align='left'>" . '<div class="picdoitac"><div class="opacity30"><img src="' . base_url(BANNER_PATH.$row->image) . '"></div></div>' . "</td>";
