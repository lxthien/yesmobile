...
<form action="<?php echo $con_link . '/delete'; ?>" method='post' name='form1' style='margin:0px'>
      <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
        <tr class="tr_title_bg">
            ...
            <td class="td_title_main" align="left">Product ID</td>
            <td class="td_title_main" align="left">Image Type</td>
    ...
    <table width="100%" cellspacing="0" cellpadding="5" align="center" class="table_border_line">
        ...
        if (isset($item_list) && sizeof($item_list) > 0) {
            foreach ($item_list as $item) {
                ...
                echo "<td width='30%'  align='left'><a href='" . $con_link . "/edit/" . $item->id . "'>".$title."</a></td>";
                echo "<td width='20%'  align='left'><a href='" . $con_link . "/edit/" . $item->id . "'>".$item->product_id."</a></td>";
                echo "<td width='20%'  align='left'><a href='" . $con_link . "/edit/" . $item->id . "'>".$item->image_type."</a></td>";
    ...
    <input type="hidden" name="hiddelete" id="hiddelete" value="<?php echo $item->id?>"/>
</form>
