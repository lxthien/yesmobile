<div class="container">           
    ...
    <form id="fileupload" action="<?php echo base_url();?>panel/admin_phone/upload/<?php echo $new_item->id;?>" method="POST" enctype="multipart/form-data">
...
<script src="<?php echo base_url();?>js/vendor/tmpl.min.js"></script>

<!-- The Load Image plugin is included for the preview images and image resizing functionality -->

<script src="<?php echo base_url();?>js/vendor/load-image.min.js"></script>

<!-- The Canvas to Blob plugin is included for image resizing functionality -->

<script src="<?php echo base_url();?>js/vendor/canvas-to-blob.min.js"></script>
